...
class BiometricIDAuth {
    ...
    init(policy: LAPolicy = .deviceOwnerAuthenticationWithBiometrics, localizedReason: String = "Verify your Identity", localizedFallbackTitle: String = "Enter App Password", localizedCancelTitle: String = "Cancel") {
        self.policy = policy
    ...
    func canEvaluate(completion: (Bool, BiometricType, BiometricError?) -> Void) {
        ...
        print(biometricType(for: context.biometryType))
    }
